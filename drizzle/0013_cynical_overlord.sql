...
ALTER TABLE "subscriptions" ADD CONSTRAINT "subscriptions_creater_id_users_id_fk" FOREIGN KEY ("creater_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;